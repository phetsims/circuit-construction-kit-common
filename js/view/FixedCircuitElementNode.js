...
const ONE_AMP_PROPERTY = new NumberProperty( 1 ); // All batteries are flammable, so treat them as if they have nonzero resistance //REVIEW: code-review checklist says this should be a NumberProperty?
