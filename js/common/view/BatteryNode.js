...
define( function( require ) {
  ...
  function BatteryNode( circuitConstructionKitScreenView, circuitNode, battery, runningProperty, viewProperty, tandem ) {
    ...
    FixedLengthCircuitElementNode.call( this, circuitConstructionKitScreenView, circuitNode, battery, viewProperty, new Image( batteryImage ), new Image( batteryImage ), 0.7, tandem );
  }
