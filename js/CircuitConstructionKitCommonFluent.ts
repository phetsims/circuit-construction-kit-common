...
const CircuitConstructionKitCommonFluent = {
  ...
  a11y: {
    ...
    circuitContextResponses: {
      ...
      currentChangePhrase: new FluentPattern<{ direction: 'changed' | 'increased' | 'decreased' | TReadOnlyProperty<'changed' | 'increased' | 'decreased'>, groupIndex: FluentVariable, scope: 'some' | 'all' | TReadOnlyProperty<'some' | 'all'> }>( fluentSupport.bundleProperty, 'a11y_circuitContextResponses_currentChangePhrase', _.get( CircuitConstructionKitCommonStrings, 'a11y.circuitContextResponses.currentChangePhraseStringProperty' ), [{"name":"direction","variants":["changed","increased","decreased"]},{"name":"groupIndex"},{"name":"scope","variants":["some","all"]}] ),
