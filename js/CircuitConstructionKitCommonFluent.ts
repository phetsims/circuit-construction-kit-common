...
addToMapIfDefined( 'pressSpaceOrEnterToOpenSwitch', 'pressSpaceOrEnterToOpenSwitchStringProperty' );
addToMapIfDefined( 'pressSpaceOrEnterToCloseSwitch', 'pressSpaceOrEnterToCloseSwitchStringProperty' );
...
const CircuitConstructionKitCommonFluent = {
  ...
  pressSpaceOrEnterToOpenSwitchStringProperty: _.get( CircuitConstructionKitCommonStrings, 'pressSpaceOrEnterToOpenSwitchStringProperty' ),
  pressSpaceOrEnterToCloseSwitchStringProperty: _.get( CircuitConstructionKitCommonStrings, 'pressSpaceOrEnterToCloseSwitchStringProperty' ),
