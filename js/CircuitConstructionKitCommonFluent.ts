...
const CircuitConstructionKitCommonFluent = {
  ...
  a11y: {
    ...
    circuitContextResponses: {
      ...
      lightBulbChangePhrase: new FluentPattern<{ direction: 'brighter' | 'dimmer' | 'off' | 'changed' | TReadOnlyProperty<'brighter' | 'dimmer' | 'off' | 'changed'>, groupIndex: FluentVariable, scope: 'some' | 'all' | TReadOnlyProperty<'some' | 'all'> }>( fluentSupport.bundleProperty, 'a11y_circuitContextResponses_lightBulbChangePhrase', _.get( CircuitConstructionKitCommonStrings, 'a11y.circuitContextResponses.lightBulbChangePhraseStringProperty' ), [{"name":"direction","variants":["brighter","dimmer","off","changed"]},{"name":"groupIndex"},{"name":"scope","variants":["some","all"]}] ),
