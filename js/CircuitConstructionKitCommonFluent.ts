...
const CircuitConstructionKitCommonFluent = {
  ...
  a11y: {
    ...
    circuitContextResponses: {
      ...
      _comment_1: new FluentComment( {"comment":"NEW: Current change patterns with scope (some/all) and direction","associatedKey":"currentChangePhrase"} ),
      ...
      _comment_2: new FluentComment( {"comment":"NEW: Light bulb brightness change patterns","associatedKey":"lightBulbChangePhrase"} ),
