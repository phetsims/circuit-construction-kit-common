...
addToMapIfDefined( 'a11y_circuitContextResponses_groupPrefix', 'a11y.circuitContextResponses.groupPrefixStringProperty' );
...
const CircuitConstructionKitCommonFluent = {
  ...
  a11y: {
    ...
    circuitContextResponses: {
      ...
      _comment_0: new FluentComment( {"comment":"NEW: When connected element changes but no current/brightness changes","associatedKey":"noChangesInGroup"} ),
      noChangesInGroup: new FluentPattern<{ groupIndex: FluentVariable, hasLightBulbs: 'true' | 'false' | TReadOnlyProperty<'true' | 'false'> }>( fluentSupport.bundleProperty, 'a11y_circuitContextResponses_noChangesInGroup', _.get( CircuitConstructionKitCommonStrings, 'a11y.circuitContextResponses.noChangesInGroupStringProperty' ), [{"name":"groupIndex"},{"name":"hasLightBulbs","variants":["true","false"]}] ),
      _comment_1: new FluentComment( {"comment":"NEW: Group prefix for context responses (used to prefix current/brightness change phrases)","associatedKey":"groupPrefix"} ),
      groupPrefix: new FluentPattern<{ groupIndex: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_circuitContextResponses_groupPrefix', _.get( CircuitConstructionKitCommonStrings, 'a11y.circuitContextResponses.groupPrefixStringProperty' ), [{"name":"groupIndex"}] ),
      _comment_2: new FluentComment( {"comment":"NEW: Current change patterns with scope (some/all) and direction","associatedKey":"currentChangePhrase"} ),
      currentChangePhrase: new FluentPattern<{ direction: 'changed' | 'increased' | 'decreased' | 'stopped' | TReadOnlyProperty<'changed' | 'increased' | 'decreased' | 'stopped'>, scope: 'some' | 'all' | TReadOnlyProperty<'some' | 'all'> }>( fluentSupport.bundleProperty, 'a11y_circuitContextResponses_currentChangePhrase', _.get( CircuitConstructionKitCommonStrings, 'a11y.circuitContextResponses.currentChangePhraseStringProperty' ), [{"name":"direction","variants":["changed","increased","decreased","stopped"]},{"name":"scope","variants":["some","all"]}] ),
      _comment_3: new FluentComment( {"comment":"NEW: Light bulb brightness change patterns","associatedKey":"lightBulbChangePhrase"} ),
      lightBulbChangePhrase: new FluentPattern<{ direction: 'brighter' | 'dimmer' | 'changed' | TReadOnlyProperty<'brighter' | 'dimmer' | 'changed'>, scope: 'some' | 'all' | TReadOnlyProperty<'some' | 'all'> }>( fluentSupport.bundleProperty, 'a11y_circuitContextResponses_lightBulbChangePhrase', _.get( CircuitConstructionKitCommonStrings, 'a11y.circuitContextResponses.lightBulbChangePhraseStringProperty' ), [{"name":"direction","variants":["brighter","dimmer","changed"]},{"name":"scope","variants":["some","all"]}] ),
      _comment_4: new FluentComment( {"comment":"NEW: Vertex connection with current flow","associatedKey":"vertexConnectedWithCurrent"} ),
      ...
      _comment_5: new FluentComment( {"comment":"NEW: Simple vertex connection (when no current flows)","associatedKey":"vertexConnectedSimple"} ),
      ...
      _comment_6: new FluentComment( {"comment":"NEW: Switch toggle responses","associatedKey":"switchOpened"} ),
      ...
      _comment_8: new FluentComment( {"comment":"NEW: Fuse tripped responses","associatedKey":"fuseTripped"} ),
      ...
      _comment_9: new FluentComment( {"comment":"NEW: Fuse repaired responses","associatedKey":"fuseRepaired"} ),
      ...
      _comment_10: new FluentComment( {"comment":"NEW: Battery reversed responses","associatedKey":"batteryReversed"} ),
      ...
      _comment_11: new FluentComment( {"comment":"NEW: Vertex disconnection responses","associatedKey":"vertexDisconnected"} ),
