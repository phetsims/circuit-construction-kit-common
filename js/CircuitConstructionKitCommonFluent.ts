...
const CircuitConstructionKitCommonFluent = {
  ...
  a11y: {
    ...
    circuitContextResponses: {
      ...
      currentChangePhrase: new FluentPattern<{ direction: 'changed' | 'increased' | 'decreased' | 'stopped' | TReadOnlyProperty<'changed' | 'increased' | 'decreased' | 'stopped'>, groupIndex: FluentVariable, scope: 'some' | 'all' | TReadOnlyProperty<'some' | 'all'> }>( fluentSupport.bundleProperty, 'a11y_circuitContextResponses_currentChangePhrase', _.get( CircuitConstructionKitCommonStrings, 'a11y.circuitContextResponses.currentChangePhraseStringProperty' ), [{"name":"direction","variants":["changed","increased","decreased","stopped"]},{"name":"groupIndex"},{"name":"scope","variants":["some","all"]}] ),
