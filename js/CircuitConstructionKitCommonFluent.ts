...
const CircuitConstructionKitCommonFluent = {
  ...
  a11y: {
    ...
    disconnectButton: {
      accessibleName: new FluentPattern<{ capacitance: FluentVariable, displayMode: 'name' | 'value' | 'count' | 'countAndValue' | TReadOnlyProperty<'name' | 'value' | 'count' | 'countAndValue'>, hasInternalResistance: 'true' | 'false' | TReadOnlyProperty<'true' | 'false'>, hasPosition: 'true' | 'false' | TReadOnlyProperty<'true' | 'false'>, inductance: FluentVariable, internalResistance: FluentVariable, isOnFire: 'true' | 'false' | TReadOnlyProperty<'true' | 'false'>, isTripped: 'true' | 'false' | TReadOnlyProperty<'true' | 'false'>, position: FluentVariable, resistance: FluentVariable, switchState: 'closed' | 'open' | TReadOnlyProperty<'closed' | 'open'>, total: FluentVariable, type: 'resistor' | 'battery' | 'lightBulb' | 'extremeBattery' | 'extremeResistor' | 'extremeLightBulb' | 'capacitor' | 'inductor' | 'acSource' | 'fuse' | 'switch' | 'voltmeter' | 'ammeter' | 'stopwatch' | 'wire' | 'false' | 'coin' | 'paperClip' | 'pencil' | 'eraser' | 'hand' | 'dollarBill' | TReadOnlyProperty<'resistor' | 'battery' | 'lightBulb' | 'extremeBattery' | 'extremeResistor' | 'extremeLightBulb' | 'capacitor' | 'inductor' | 'acSource' | 'fuse' | 'switch' | 'voltmeter' | 'ammeter' | 'stopwatch' | 'wire' | 'false' | 'coin' | 'paperClip' | 'pencil' | 'eraser' | 'hand' | 'dollarBill'>, voltage: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_disconnectButton_accessibleName', _.get( CircuitConstructionKitCommonStrings, 'a11y.disconnectButton.accessibleNameStringProperty' ), [{"name":"capacitance"},{"name":"displayMode","variants":["name","value","count","countAndValue"]},{"name":"hasInternalResistance","variants":["true","false"]},{"name":"hasPosition","variants":["true","false"]},{"name":"inductance"},{"name":"internalResistance"},{"name":"isOnFire","variants":["true","false"]},{"name":"isTripped","variants":["true","false"]},{"name":"position"},{"name":"resistance"},{"name":"switchState","variants":["closed","open"]},{"name":"total"},{"name":"type","variants":["resistor","battery","lightBulb","extremeBattery","extremeResistor","extremeLightBulb","capacitor","inductor","acSource","fuse","switch","voltmeter","ammeter","stopwatch","wire","false","coin","paperClip","pencil","eraser","hand","dollarBill"]},{"name":"voltage"}] )
    },
    trashButton: {
