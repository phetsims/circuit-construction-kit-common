...
addToMapIfDefined( 'keyboardHelpDialog_circuitComponentsAndTools_editComponent', 'keyboardHelpDialog.circuitComponentsAndTools.editComponentStringProperty' );
addToMapIfDefined( 'keyboardHelpDialog_circuitComponentsAndTools_cutConnections', 'keyboardHelpDialog.circuitComponentsAndTools.cutConnectionsStringProperty' );
...
addToMapIfDefined( 'a11y_circuitDescription_circuitComponentTypePlurals_nonContactAmmeter', 'a11y.circuitDescription.circuitComponentTypePlurals.nonContactAmmeterStringProperty' );
...
addToMapIfDefined( 'a11y_circuitDescription_componentsHeading', 'a11y.circuitDescription.componentsHeadingStringProperty' );
addToMapIfDefined( 'a11y_circuitDescription_connectionsHeading', 'a11y.circuitDescription.connectionsHeadingStringProperty' );
...
addToMapIfDefined( 'a11y_measurementToolsToolbox_toolDisabledHelpText', 'a11y.measurementToolsToolbox.toolDisabledHelpTextStringProperty' );
...
addToMapIfDefined( 'a11y_circuitComponentToolbox_toolDisabledHelpText', 'a11y.circuitComponentToolbox.toolDisabledHelpTextStringProperty' );
...
const CircuitConstructionKitCommonFluent = {
  ...
  keyboardHelpDialog: {
    circuitComponentsAndTools: {
      ...
      removeFromToolboxStringProperty: _.get( CircuitConstructionKitCommonStrings, 'keyboardHelpDialog.circuitComponentsAndTools.removeFromToolboxStringProperty' ),
      returnToToolboxStringProperty: _.get( CircuitConstructionKitCommonStrings, 'keyboardHelpDialog.circuitComponentsAndTools.returnToToolboxStringProperty' ),
      editComponentStringProperty: _.get( CircuitConstructionKitCommonStrings, 'keyboardHelpDialog.circuitComponentsAndTools.editComponentStringProperty' ),
      cutConnectionsStringProperty: _.get( CircuitConstructionKitCommonStrings, 'keyboardHelpDialog.circuitComponentsAndTools.cutConnectionsStringProperty' )
    },
    focus: {
  ...
  a11y: {
    ...
    circuitDescription: {
      _comment_0: new FluentComment( {"comment":"These labels are intentionally separate from the top-level visual strings because:","associatedKey":"circuitComponentTypeLabels"} ),
      _comment_1: new FluentComment( {"comment":"1. Some differ intentionally (e.g., visual \"AC Voltage\" vs a11y \"AC Source\")","associatedKey":"circuitComponentTypeLabels"} ),
      _comment_2: new FluentComment( {"comment":"2. a11y strings may need different phrasing optimized for screen readers","associatedKey":"circuitComponentTypeLabels"} ),
      _comment_3: new FluentComment( {"comment":"3. Keeping them separate allows independent translation and future customization","associatedKey":"circuitComponentTypeLabels"} ),
      ...
      _comment_4: new FluentComment( {"comment":"Plural forms for circuit component types (used in compressed connection descriptions)","associatedKey":"circuitComponentTypePlurals"} ),
      circuitComponentTypePlurals: {
        ...
        nonContactAmmeterStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_circuitDescription_circuitComponentTypePlurals_nonContactAmmeter', _.get( CircuitConstructionKitCommonStrings, 'a11y.circuitDescription.circuitComponentTypePlurals.nonContactAmmeterStringProperty' ) ),
      ...
      _comment_5: new FluentComment( {"comment":"Terminal and connection prefixes for vertex descriptions","associatedKey":"terminalPrefix"} ),
      ...
      _comment_6: new FluentComment( {"comment":"Brief name for a circuit element (type + position number)","associatedKey":"briefName"} ),
      ...
      _comment_7: new FluentComment( {"comment":"Connection description patterns","associatedKey":"connectionDescription"} ),
      ...
      _comment_8: new FluentComment( {"comment":"For compressed descriptions with 4+ connections","associatedKey":"compressedSingular"} ),
      ...
      _comment_9: new FluentComment( {"comment":"List joining patterns","associatedKey":"listAnd"} ),
      ...
      _comment_10: new FluentComment( {"comment":"Group patterns","associatedKey":"componentsHeading"} ),
      componentsHeadingStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_circuitDescription_componentsHeading', _.get( CircuitConstructionKitCommonStrings, 'a11y.circuitDescription.componentsHeadingStringProperty' ) ),
      connectionsHeadingStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_circuitDescription_connectionsHeading', _.get( CircuitConstructionKitCommonStrings, 'a11y.circuitDescription.connectionsHeadingStringProperty' ) ),
      ...
      _comment_11: new FluentComment( {"comment":"Suffix appended to accessible name when a circuit element is selected","associatedKey":"accessibleNameWithSelected"} ),
      ...
      _comment_12: new FluentComment( {"comment":"Suffix appended to accessible name for first/last items in a group","associatedKey":"groupSuffixFirst"} ),
    ...
    circuitGroupDescription: {
      ...
      _comment_3: new FluentComment( {"comment":"Current flow status - includes rate information when current is flowing","associatedKey":"currentFlowStatus"} ),
      currentFlowStatus: new FluentPattern<{ flowLevel: 'all' | 'some' | 'none' | 'notShown' | TReadOnlyProperty<'all' | 'some' | 'none' | 'notShown'>, rateCount: number | 'one' | number | 'other' | number | 'one' | number | 'other' | TReadOnlyProperty<number | 'one' | number | 'other' | number | 'one' | number | 'other'> }>( fluentSupport.bundleProperty, 'a11y_circuitGroupDescription_currentFlowStatus', _.get( CircuitConstructionKitCommonStrings, 'a11y.circuitGroupDescription.currentFlowStatusStringProperty' ), [{"name":"flowLevel","variants":["all","some","none","notShown"]},{"name":"rateCount","variants":[{"type":"number","value":"one"},{"type":"number","value":"other"},{"type":"number","value":"one"},{"type":"number","value":"other"}]}] )
    },
    screenSummary: {
    ...
    circuitContextResponses: {
      ...
      currentChangePhrase: new FluentPattern<{ direction: 'changed' | 'increased' | 'decreased' | 'stopped' | 'reversed' | 'started' | TReadOnlyProperty<'changed' | 'increased' | 'decreased' | 'stopped' | 'reversed' | 'started'>, groupIndex: FluentVariable, scope: 'some' | 'all' | TReadOnlyProperty<'some' | 'all'> }>( fluentSupport.bundleProperty, 'a11y_circuitContextResponses_currentChangePhrase', _.get( CircuitConstructionKitCommonStrings, 'a11y.circuitContextResponses.currentChangePhraseStringProperty' ), [{"name":"direction","variants":["changed","increased","decreased","stopped","reversed","started"]},{"name":"groupIndex"},{"name":"scope","variants":["some","all"]}] ),
      _comment_3: new FluentComment( {"comment":"Light bulb brightness change patterns","associatedKey":"lightBulbChangePhrase"} ),
      lightBulbChangePhrase: new FluentPattern<{ direction: 'brighter' | 'dimmer' | 'on' | 'off' | 'changed' | TReadOnlyProperty<'brighter' | 'dimmer' | 'on' | 'off' | 'changed'>, groupIndex: FluentVariable, scope: 'some' | 'all' | TReadOnlyProperty<'some' | 'all'> }>( fluentSupport.bundleProperty, 'a11y_circuitContextResponses_lightBulbChangePhrase', _.get( CircuitConstructionKitCommonStrings, 'a11y.circuitContextResponses.lightBulbChangePhraseStringProperty' ), [{"name":"direction","variants":["brighter","dimmer","on","off","changed"]},{"name":"groupIndex"},{"name":"scope","variants":["some","all"]}] ),
    ...
    measurementToolsToolbox: {
      ...
      toolDisabledHelpText: new FluentPattern<{ componentType: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_measurementToolsToolbox_toolDisabledHelpText', _.get( CircuitConstructionKitCommonStrings, 'a11y.measurementToolsToolbox.toolDisabledHelpTextStringProperty' ), [{"name":"componentType"}] ),
      nonContactAmmeter: {
    ...
    circuitComponentToolbox: {
      ...
      toolDisabledHelpText: new FluentPattern<{ componentType: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_circuitComponentToolbox_toolDisabledHelpText', _.get( CircuitConstructionKitCommonStrings, 'a11y.circuitComponentToolbox.toolDisabledHelpTextStringProperty' ), [{"name":"componentType"}] )
    },
