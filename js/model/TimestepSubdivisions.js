...
define( require => {
  ...
  const ResultSet = require( 'CIRCUIT_CONSTRUCTION_KIT_COMMON/model/ResultSet' );
  ...
  return circuitConstructionKitCommon.register( 'TimestepSubdivisions', TimestepSubdivisions );
} );